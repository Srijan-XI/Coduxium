(() => {
	...
	const frameworks = [
		...
		{ type: 'framework', name: 'Oak', intro: 'Framework/BFW/Oak/Oak.html', folder: 'Framework/BFW/Oak' },
		{ type: 'framework', name: 'Actix Web', intro: 'Framework/BFW/ActixWeb/ActixWeb.html', folder: 'Framework/BFW/ActixWeb' },
		{ type: 'framework', name: 'Axum', intro: 'Framework/BFW/Axum/Axum.html', folder: 'Framework/BFW/Axum' },
		{ type: 'framework', name: 'Leptos', intro: 'Framework/BFW/Leptos/Leptos.html', folder: 'Framework/BFW/Leptos' },
		{ type: 'framework', name: 'Phoenix', intro: 'Framework/BFW/Phoenix/Phoenix.html', folder: 'Framework/BFW/Phoenix' },
		{ type: 'framework', name: 'Deno Runtime', intro: 'Framework/BFW/DenoRuntime/DenoRuntime.html', folder: 'Framework/BFW/DenoRuntime' },
		{ type: 'framework', name: 'SOAP', intro: 'Framework/BFW/SOAP/SOAP.html', folder: 'Framework/BFW/SOAP' },
		{ type: 'framework', name: 'AsyncAPI', intro: 'Framework/BFW/AsyncAPI/AsyncAPI.html', folder: 'Framework/BFW/AsyncAPI' },
		{ type: 'framework', name: 'OAuth 2.0 / OIDC', intro: 'Framework/BFW/OAuth2OIDC/OAuth2OIDC.html', folder: 'Framework/BFW/OAuth2OIDC' },
		{ type: 'framework', name: 'SAML', intro: 'Framework/BFW/SAML/SAML.html', folder: 'Framework/BFW/SAML' },
		{ type: 'framework', name: 'Sidekiq', intro: 'Framework/BFW/Sidekiq/Sidekiq.html', folder: 'Framework/BFW/Sidekiq' },
		{ type: 'framework', name: 'Webhooks', intro: 'Framework/BFW/Webhooks/Webhooks.html', folder: 'Framework/BFW/Webhooks' },
	...
	const tools = [
		...
		{ type: 'tool', name: 'Tekton', intro: 'DevOps-I&A/Tekton/Tekton.html', folder: 'DevOps-I&A/Tekton' },
		{ type: 'tool', name: 'Helm', intro: 'DevOps-I&A/Helm/Helm.html', folder: 'DevOps-I&A/Helm' },
		{ type: 'tool', name: 'Kustomize', intro: 'DevOps-I&A/Kustomize/Kustomize.html', folder: 'DevOps-I&A/Kustomize' },
		{ type: 'tool', name: 'Skaffold', intro: 'DevOps-I&A/Skaffold/Skaffold.html', folder: 'DevOps-I&A/Skaffold' },
		{ type: 'tool', name: 'Podman', intro: 'DevOps-I&A/Podman/Podman.html', folder: 'DevOps-I&A/Podman' },
		{ type: 'tool', name: 'Nomad', intro: 'DevOps-I&A/Nomad/Nomad.html', folder: 'DevOps-I&A/Nomad' },
		{ type: 'tool', name: 'Consul', intro: 'DevOps-I&A/Consul/Consul.html', folder: 'DevOps-I&A/Consul' },
		{ type: 'tool', name: 'Istio', intro: 'DevOps-I&A/Istio/Istio.html', folder: 'DevOps-I&A/Istio' },
		{ type: 'tool', name: 'OpenTofu', intro: 'DevOps-I&A/OpenTofu/OpenTofu.html', folder: 'DevOps-I&A/OpenTofu' },
		{ type: 'tool', name: 'Pulumi', intro: 'DevOps-I&A/Pulumi/Pulumi.html', folder: 'DevOps-I&A/Pulumi' },
		{ type: 'tool', name: 'Flux', intro: 'DevOps-I&A/Flux/Flux.html', folder: 'DevOps-I&A/Flux' },
		{ type: 'tool', name: 'Linode', intro: 'DevOps-I&A/Linode/Linode.html', folder: 'DevOps-I&A/Linode' },
		{ type: 'tool', name: 'IBM Cloud', intro: 'DevOps-I&A/IBMCloud/IBMCloud.html', folder: 'DevOps-I&A/IBMCloud' },
		{ type: 'tool', name: 'Loki', intro: 'DevOps-I&A/Loki/Loki.html', folder: 'DevOps-I&A/Loki' },
		{ type: 'tool', name: 'Zipkin', intro: 'DevOps-I&A/Zipkin/Zipkin.html', folder: 'DevOps-I&A/Zipkin' },
		{ type: 'tool', name: 'CloudWatch', intro: 'DevOps-I&A/CloudWatch/CloudWatch.html', folder: 'DevOps-I&A/CloudWatch' },
		{ type: 'tool', name: 'n8n', intro: 'DevOps-I&A/n8n/n8n.html', folder: 'DevOps-I&A/n8n' },
